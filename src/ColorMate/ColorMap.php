...
class ColorMap
{
    ...
    {
        if (array_key_exists($color, static::$colors)) return static::$colors[$color];
        throw new \InvalidArgumentException('Given Color Name not found.');
    }

    public static function find($color)
    {
        return array_search([
